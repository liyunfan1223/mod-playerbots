...
{
   public:
    NewPlayerNearbyValue(PlayerbotAI *botAI)
        : CalculatedValue<ObjectGuid>(botAI, "new player nearby")
    {
    }
...
{
   public:
    AlreadySeenPlayersValue(PlayerbotAI *botAI)
        : ManualSetValue<GuidSet &>(botAI, data, "already seen players")
    {
    }
