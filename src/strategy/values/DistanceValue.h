...
{
   public:
    DistanceValue(PlayerbotAI *botAI, std::string const name = "distance")
        : FloatCalculatedValue(botAI, name)
    {
    }
...
{
   public:
    InsideTargetValue(PlayerbotAI *botAI, std::string const name = "inside target")
