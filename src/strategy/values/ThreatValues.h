...
{
   public:
    ThreatValue(PlayerbotAI *botAI, std::string const name = "threat")
...
{
   public:
    NeglectThreatResetValue(PlayerbotAI *ai, bool defaultValue = false,
                            std::string name = "neglect threat")
