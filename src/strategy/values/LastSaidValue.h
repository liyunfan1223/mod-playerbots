...
{
   public:
    LastSaidValue(PlayerbotAI *botAI)
        : ManualSetValue<time_t>(botAI, time(nullptr) - 120, "last said")
    {
    }
};
...
{
   public:
    LastEmoteValue(PlayerbotAI *botAI)
        : ManualSetValue<time_t>(botAI, time(nullptr) - 120, "last emote")
    {
    }
};
