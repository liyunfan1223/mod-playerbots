...
{
    return NextAction::array(0, new NextAction("death and decay", ACTION_DEFAULT + 1.0f),
...
void UnholyDKStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(0, new NextAction("ghoul frenzy", ACTION_DEFAULT + 5.0f),
...
void UnholyDKAoeStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    triggers.push_back(new TriggerNode(
        "loot available",
        NextAction::array(0, new NextAction("corpse explosion", ACTION_NORMAL + 1), nullptr)));
    triggers.push_back(new TriggerNode(
        "medium aoe",
