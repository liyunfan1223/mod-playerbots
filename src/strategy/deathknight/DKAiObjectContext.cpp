...
private:
    ...
    // static Action* icy_clutch(PlayerbotAI* botAI) { return new
    // CastIcyClutchAction(botAI); }
    ...
    // static Action* hysteria(PlayerbotAI* botAI) { return new
    // CastHysteriaAction(botAI); }
