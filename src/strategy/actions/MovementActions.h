...
class AutoFleeAction : public MovementAction
{
    public:
        AutoFleeAction(PlayerbotAI* botAI, float distance= sPlayerbotAIConfig->fleeDistance) : MovementAction(botAI, "auto flee"), distance(distance) { }
