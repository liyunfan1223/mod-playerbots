...
BattleBotPath vPath_AV_Icewing_Bunker_Crossroad_to_Frostdagger_Pass_Lower = {
    ...
    // captain down in first wave since uneeded dismounting was fixed) { 68.793f, -396.742f, 45.299f, nullptr },
...
bool BGTactics::moveToObjective()
{
    ...
    // get bots out of cave when respawned there (otherwise path selection happens while they're deep within cave and
    // the results arent good)
