...
bool ChatReplyAction::HandleThunderfuryReply(Player* bot, ChatChannelSource chatChannelSource, [[maybe_unused]] std::string& msg, std::string& name)
{
    std::map<std::string, std::string> placeholders;
...
bool ChatReplyAction::HandleToxicLinksReply(Player* bot, ChatChannelSource chatChannelSource, [[maybe_unused]] std::string& msg, std::string& name)
{
    //quests
