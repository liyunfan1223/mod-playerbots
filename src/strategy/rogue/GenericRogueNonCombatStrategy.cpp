...
GenericRogueNonCombatStrategy::GenericRogueNonCombatStrategy(PlayerbotAI *botAI)
...
void GenericRogueNonCombatStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    ...
    triggers.push_back(
        new TriggerNode("often", NextAction::array(0, new NextAction("unstealth", 30.0f), NULL)));
}
