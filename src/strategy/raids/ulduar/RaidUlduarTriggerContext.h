...
public:
    RaidUlduarTriggerContext()
    {
        ...
        creators["kologarn taunt trigger"] = &RaidUlduarTriggerContext::kologarn_taunt_trigger;
        creators["kologarn attack main body trigger"] = &RaidUlduarTriggerContext::kologarn_attack_main_body_trigger;
...
private:
    ...
    static Trigger* kologarn_taunt_trigger(PlayerbotAI* ai) { return new KologarnTauntTrigger(ai); }
    static Trigger* kologarn_attack_main_body_trigger(PlayerbotAI* ai) { return new KologarnAttackMainBodyTrigger(ai); }
