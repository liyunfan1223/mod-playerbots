...
class RaidNaxxTriggerContext : public NamedObjectContext<Trigger>
{
   ...
   private:
    ...
    static Trigger *mutating_injection_removed(PlayerbotAI *ai)
    {
        return new MutatingInjectionRemovedTrigger(ai);
    }
    ...
    static Trigger *thaddius_phase_pet_lose_aggro(PlayerbotAI *ai)
    {
        return new ThaddiusPhasePetLoseAggroTrigger(ai);
    }
    static Trigger *thaddius_phase_transition(PlayerbotAI *ai)
    {
        return new ThaddiusPhaseTransitionTrigger(ai);
    }
    static Trigger *thaddius_phase_thaddius(PlayerbotAI *ai)
    {
        return new ThaddiusPhaseThaddiusTrigger(ai);
    }
    ...
    static Trigger *horseman_attractors(PlayerbotAI *ai)
    {
        return new HorsemanAttractorsTrigger(ai);
    }
    static Trigger *horseman_except_attractors(PlayerbotAI *ai)
    {
        return new HorsemanExceptAttractorsTrigger(ai);
    }
    ...
    static Trigger *gluth_main_tank_mortal_wound(PlayerbotAI *ai)
    {
        return new GluthMainTankMortalWoundTrigger(ai);
    }
