// /*
//  * Copyright (C) 2016+ AzerothCore <www.azerothcore.org>, released under GNU GPL v2 license, you
//  may redistribute it and/or modify it under version 2 of the License, or (at your option), any
//  later version.
//  */
...
class RaidNaxxActionContext : public NamedObjectContext<Action>
{
   ...
   private:
    ...
    static Action *grobbulus_move_center(PlayerbotAI *ai)
    {
        return new GrobblulusMoveCenterAction(ai);
    }
    ...
    static Action *thaddius_attack_nearest_pet(PlayerbotAI *ai)
    {
        return new ThaddiusAttackNearestPetAction(ai);
    }
    // static Action* thaddius_tank_to_place(PlayerbotAI* ai) { return new
    // ThaddiusMeleeToPlaceAction(ai); } static Action* thaddius_ranged_to_place(PlayerbotAI* ai) {
    // return new ThaddiusRangedToPlaceAction(ai); }
    static Action *thaddius_move_to_platform(PlayerbotAI *ai)
    {
        return new ThaddiusMoveToPlatformAction(ai);
    }
    static Action *thaddius_move_polarity(PlayerbotAI *ai)
    {
        return new ThaddiusMovePolarityAction(ai);
    }
    ...
    static Action *horseman_attack_in_order(PlayerbotAI *ai)
    {
        return new HorsemanAttactInOrderAction(ai);
    }
    // static Action* sapphiron_ground_main_tank_position(PlayerbotAI* ai) { return new
    // SapphironGroundMainTankPositionAction(ai); }
    static Action *sapphiron_ground_position(PlayerbotAI *ai)
    {
        return new SapphironGroundPositionAction(ai);
    }
    static Action *sapphiron_flight_position(PlayerbotAI *ai)
    {
        return new SapphironFlightPositionAction(ai);
    }
    // static Action* sapphiron_avoid_chill(PlayerbotAI* ai) { return new
    // SapphironAvoidChillAction(ai); }
    static Action *kelthuzad_choose_target(PlayerbotAI *ai)
    {
        return new KelthuzadChooseTargetAction(ai);
    }
    static Action *kelthuzad_position(PlayerbotAI *ai) { return new KelthuzadPositionAction(ai); }
    static Action *anubrekhan_choose_target(PlayerbotAI *ai)
    {
        return new AnubrekhanChooseTargetAction(ai);
    }
    ...
    static Action *loatheb_choose_target(PlayerbotAI *ai)
    {
        return new LoathebChooseTargetAction(ai);
    }
};
