...
// {
// public:
//     SapphironGroundExceptMainTankTrigger(PlayerbotAI* ai) : BossPhaseTrigger(ai, "sapphiron", (1
//     << (2 - 1)), "sapphiron ground except main tank") {} virtual bool IsActive();
// };
...
// {
// public:
//     SapphironGroundChillTrigger(PlayerbotAI* ai) : BossPhaseTrigger(ai, "sapphiron", 0,
//     "sapphiron chill") {} virtual bool IsActive();
// };

// class KelthuzadPhaseTwoTrigger : public BossPhaseTrigger
// {
// public:
//     KelthuzadPhaseTwoTrigger(PlayerbotAI* ai) : BossPhaseTrigger(ai, "kel'thuzad", 1 << (2 - 1),
//     "kel'thuzad trigger") {}
// };
