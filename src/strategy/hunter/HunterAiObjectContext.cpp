...
class HunterBuffStrategyFactoryInternal : public NamedObjectContext<Strategy>
{
   ...
   private:
    ...
    static Strategy *rnature(PlayerbotAI *botAI)
    {
        return new HunterNatureResistanceStrategy(botAI);
    }
};
...
class HunterTriggerFactoryInternal : public NamedObjectContext<Trigger>
{
   public:
    HunterTriggerFactoryInternal()
    {
        ...
        creators["hunters pet medium health"] =
            &HunterTriggerFactoryInternal::hunters_pet_medium_health;
        ...
        creators["serpent sting on attacker"] =
            &HunterTriggerFactoryInternal::serpent_sting_on_attacker;
        creators["pet not happy"] = &HunterTriggerFactoryInternal::pet_not_happy;
        creators["concussive shot on snare target"] =
            &HunterTriggerFactoryInternal::concussive_shot_on_snare_target;
        ...
        creators["misdirection on main tank"] =
            &HunterTriggerFactoryInternal::misdirection_on_main_tank;
   ...
   private:
    ...
    static Trigger *serpent_sting_on_attacker(PlayerbotAI *botAI)
    {
        return new SerpentStingOnAttackerTrigger(botAI);
    }
    static Trigger *trueshot_aura(PlayerbotAI *botAI) { return new TrueshotAuraTrigger(botAI); }
    static Trigger *aspect_of_the_viper(PlayerbotAI *botAI)
    {
        return new HunterAspectOfTheViperTrigger(botAI);
    }
    ...
    static Trigger *hunters_pet_dead(PlayerbotAI *botAI)
    {
        return new HuntersPetDeadTrigger(botAI);
    }
    static Trigger *hunters_pet_low_health(PlayerbotAI *botAI)
    {
        return new HuntersPetLowHealthTrigger(botAI);
    }
    static Trigger *hunters_pet_medium_health(PlayerbotAI *botAI)
    {
        return new HuntersPetMediumHealthTrigger(botAI);
    }
    ...
    static Trigger *aspect_of_the_pack(PlayerbotAI *botAI)
    {
        return new HunterAspectOfThePackTrigger(botAI);
    }
    static Trigger *rapid_fire(PlayerbotAI *botAI) { return new RapidFireTrigger(botAI); }
    static Trigger *aspect_of_the_hawk(PlayerbotAI *botAI)
    {
        return new HunterAspectOfTheHawkTrigger(botAI);
    }
    static Trigger *aspect_of_the_monkey(PlayerbotAI *botAI)
    {
        return new HunterAspectOfTheMonkeyTrigger(botAI);
    }
    static Trigger *aspect_of_the_wild(PlayerbotAI *botAI)
    {
        return new HunterAspectOfTheWildTrigger(botAI);
    }
    ...
    static Trigger *switch_to_ranged(PlayerbotAI *botAI)
    {
        return new SwitchToRangedTrigger(botAI);
    }
    static Trigger *misdirection_on_main_tank(PlayerbotAI *ai)
    {
        return new MisdirectionOnMainTankTrigger(ai);
    }
...
class HunterAiObjectContextInternal : public NamedObjectContext<Action>
{
   public:
    HunterAiObjectContextInternal()
    {
        ...
        creators["serpent sting on attacker"] =
            &HunterAiObjectContextInternal::serpent_sting_on_attacker;
        ...
        creators["aspect of the dragonhawk"] =
            &HunterAiObjectContextInternal::aspect_of_the_dragonhawk;
        ...
        creators["misdirection on main tank"] =
            &HunterAiObjectContextInternal::misdirection_on_main_tank;
    }

   private:
    static Action *scare_beast(PlayerbotAI *botAI) { return new CastScareBeastAction(botAI); }
    static Action *scare_beast_on_cc(PlayerbotAI *botAI)
    {
        return new CastScareBeastCcAction(botAI);
    }
    ...
    static Action *concussive_shot(PlayerbotAI *botAI)
    {
        return new CastConcussiveShotAction(botAI);
    }
    static Action *distracting_shot(PlayerbotAI *botAI)
    {
        return new CastDistractingShotAction(botAI);
    }
    ...
    static Action *serpent_sting_on_attacker(PlayerbotAI *botAI)
    {
        return new CastSerpentStingOnAttackerAction(botAI);
    }
    ...
    static Action *aspect_of_the_hawk(PlayerbotAI *botAI)
    {
        return new CastAspectOfTheHawkAction(botAI);
    }
    static Action *aspect_of_the_monkey(PlayerbotAI *botAI)
    {
        return new CastAspectOfTheMonkeyAction(botAI);
    }
    static Action *aspect_of_the_wild(PlayerbotAI *botAI)
    {
        return new CastAspectOfTheWildAction(botAI);
    }
    static Action *aspect_of_the_viper(PlayerbotAI *botAI)
    {
        return new CastAspectOfTheViperAction(botAI);
    }
    static Action *aspect_of_the_pack(PlayerbotAI *botAI)
    {
        return new CastAspectOfThePackAction(botAI);
    }
    static Action *aspect_of_the_cheetah(PlayerbotAI *botAI)
    {
        return new CastAspectOfTheCheetahAction(botAI);
    }
    ...
    static Action *aspect_of_the_dragonhawk(PlayerbotAI *ai)
    {
        return new CastAspectOfTheDragonhawkAction(ai);
    }
    static Action *tranquilizing_shot(PlayerbotAI *ai)
    {
        return new CastTranquilizingShotAction(ai);
    }
    ...
    static Action *misdirection_on_main_tank(PlayerbotAI *ai)
    {
        return new CastMisdirectionOnMainTankAction(ai);
    }
};
