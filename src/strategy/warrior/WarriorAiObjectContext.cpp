...
class WarriorTriggerFactoryInternal : public NamedObjectContext<Trigger>
{
   public:
    WarriorTriggerFactoryInternal()
    {
        ...
        creators["shield bash on enemy healer"] =
            &WarriorTriggerFactoryInternal::shield_bash_on_enemy_healer;
        ...
        creators["thunder clap on snare target"] =
            &WarriorTriggerFactoryInternal::thunder_clap_on_snare_target;
        ...
        creators["intercept on enemy healer"] =
            &WarriorTriggerFactoryInternal::intercept_on_enemy_healer;
        ...
        creators["intercept on snare target"] =
            &WarriorTriggerFactoryInternal::intercept_on_snare_target;
        ...
        creators["shockwave on snare target"] =
            &WarriorTriggerFactoryInternal::shockwave_on_snare_target;
        ...
        creators["intercept and far enemy"] =
            &WarriorTriggerFactoryInternal::intercept_and_far_enemy;
   ...
   private:
    ...
    static Trigger *defensive_stance(PlayerbotAI *botAI)
    {
        return new DefensiveStanceTrigger(botAI);
    }
    static Trigger *berserker_stance(PlayerbotAI *botAI)
    {
        return new BerserkerStanceTrigger(botAI);
    }
    ...
    static Trigger *rend_on_attacker(PlayerbotAI *botAI)
    {
        return new RendDebuffOnAttackerTrigger(botAI);
    }
    static Trigger *bloodrage(PlayerbotAI *botAI) { return new BloodrageBuffTrigger(botAI); }
    static Trigger *shield_bash(PlayerbotAI *botAI)
    {
        return new ShieldBashInterruptSpellTrigger(botAI);
    }
    ...
    static Trigger *intercept_can_cast(PlayerbotAI *botAI)
    {
        return new InterceptCanCastTrigger(botAI);
    }
    ...
    static Trigger *intercept_on_snare_target(PlayerbotAI *botAI)
    {
        return new InterceptSnareTrigger(botAI);
    }
    static Trigger *spell_reflection(PlayerbotAI *botAI)
    {
        return new SpellReflectionTrigger(botAI);
    }
    static Trigger *taste_for_blood(PlayerbotAI *botAI) { return new TasteForBloodTrigger(botAI); }
    static Trigger *shockwave_on_snare_target(PlayerbotAI *botAI)
    {
        return new ShockwaveSnareTrigger(botAI);
    }
    ...
    static Trigger *commanding_shout(PlayerbotAI *botAI)
    {
        return new CommandingShoutTrigger(botAI);
    }
    static Trigger *taunt_on_snare_target(PlayerbotAI *botAI)
    {
        return new TauntSnareTrigger(botAI);
    }
    static Trigger *intercept(PlayerbotAI *botAI)
    {
        return new InterceptInterruptSpellTrigger(botAI);
    }
    ...
    static Trigger *berserker_rage(PlayerbotAI *botAI)
    {
        return new BerserkerRageBuffTrigger(botAI);
    }
    static Trigger *bloodthirst(PlayerbotAI *botAI) { return new BloodthirstBuffTrigger(botAI); }
    static Trigger *thunder_clap_on_snare_target(PlayerbotAI *botAI)
    {
        return new ThunderClapSnareTrigger(botAI);
    }
    static Trigger *thunder_clap(PlayerbotAI *botAI) { return new ThunderClapTrigger(botAI); }
    static Trigger *mortal_strike(PlayerbotAI *botAI)
    {
        return new MortalStrikeDebuffTrigger(botAI);
    }
...
class WarriorAiObjectContextInternal : public NamedObjectContext<Action>
{
   public:
    WarriorAiObjectContextInternal()
    {
        ...
        creators["shockwave on snare target"] =
            &WarriorAiObjectContextInternal::shockwave_on_snare_target;
        ...
        creators["shield bash on enemy healer"] =
            &WarriorAiObjectContextInternal::shield_bash_on_enemy_healer;
        ...
        creators["pummel on enemy healer"] =
            &WarriorAiObjectContextInternal::pummel_on_enemy_healer;
        creators["recklessness"] = &WarriorAiObjectContextInternal::recklessness;
        ...
        creators["thunder clap on snare target"] =
            &WarriorAiObjectContextInternal::thunder_clap_on_snare_target;
        creators["taunt on snare target"] = &WarriorAiObjectContextInternal::taunt_on_snare_target;
        creators["intercept on enemy healer"] =
            &WarriorAiObjectContextInternal::intercept_on_enemy_healer;
        creators["intercept on snare target"] =
            &WarriorAiObjectContextInternal::intercept_on_snare_target;
        ...
        creators["heroic throw on snare target"] =
            &WarriorAiObjectContextInternal::heroic_throw_on_snare_target;
   ...
   private:
    ...
    static Action *shockwave_on_snare_target(PlayerbotAI *botAI)
    {
        return new CastShockwaveSnareAction(botAI);
    }
    static Action *cleave(PlayerbotAI *botAI) { return new CastCleaveAction(botAI); }
    static Action *concussion_blow(PlayerbotAI *botAI)
    {
        return new CastConcussionBlowAction(botAI);
    }
    ...
    static Action *rend_on_attacker(PlayerbotAI *botAI)
    {
        return new CastRendOnAttackerAction(botAI);
    }
    ...
    static Action *defensive_stance(PlayerbotAI *botAI)
    {
        return new CastDefensiveStanceAction(botAI);
    }
    ...
    static Action *intimidating_shout(PlayerbotAI *botAI)
    {
        return new CastIntimidatingShoutAction(botAI);
    }
    static Action *demoralizing_shout(PlayerbotAI *botAI)
    {
        return new CastDemoralizingShoutAction(botAI);
    }
    ...
    static Action *challenging_shout(PlayerbotAI *botAI)
    {
        return new CastChallengingShoutAction(botAI);
    }
    ...
    static Action *battle_shout_taunt(PlayerbotAI *botAI)
    {
        return new CastBattleShoutTauntAction(botAI);
    }
    ...
    static Action *intercept_on_snare_target(PlayerbotAI *botAI)
    {
        return new CastInterceptOnSnareTargetAction(botAI);
    }
    static Action *intercept_on_enemy_healer(PlayerbotAI *botAI)
    {
        return new CastInterceptOnEnemyHealerAction(botAI);
    }
    static Action *taunt_on_snare_target(PlayerbotAI *botAI)
    {
        return new CastTauntOnSnareTargetAction(botAI);
    }
    static Action *thunder_clap_on_snare_target(PlayerbotAI *botAI)
    {
        return new CastThunderClapSnareAction(botAI);
    }
    static Action *berserker_stance(PlayerbotAI *botAI)
    {
        return new CastBerserkerStanceAction(botAI);
    }
    static Action *commanding_shout(PlayerbotAI *botAI)
    {
        return new CastCommandingShoutAction(botAI);
    }
    ...
    static Action *sweeping_strikes(PlayerbotAI *botAI)
    {
        return new CastSweepingStrikesAction(botAI);
    }
    ...
    static Action *pummel_on_enemy_healer(PlayerbotAI *botAI)
    {
        return new CastPummelOnEnemyHealerAction(botAI);
    }
    ...
    static Action *spell_reflection(PlayerbotAI *botAI)
    {
        return new CastSpellReflectionAction(botAI);
    }
    static Action *shattering_throw(PlayerbotAI *botAI)
    {
        return new CastShatteringThrowAction(botAI);
    }
    static Action *heroic_throw_on_snare_target(PlayerbotAI *botAI)
    {
        return new CastHeroicThrowSnareAction(botAI);
    }
