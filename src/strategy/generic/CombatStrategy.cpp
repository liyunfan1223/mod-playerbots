...
void AvoidAoeStrategy::InitTriggers([[maybe_unused]] std::vector<TriggerNode*>& triggers)
{
}

void AvoidAoeStrategy::InitMultipliers([[maybe_unused]] std::vector<Multiplier*>& multipliers)
{
...
void TankFaceStrategy::InitTriggers([[maybe_unused]] std::vector<TriggerNode*>& triggers)
{
}
