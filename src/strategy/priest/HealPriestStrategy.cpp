...
void HealPriestStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(
            0, new NextAction("power word: shield on party", ACTION_CRITICAL_HEAL + 6),
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(
            0, new NextAction("reach party member to heal", ACTION_CRITICAL_HEAL + 10), nullptr)));
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(0, new NextAction("pain suppression on party", ACTION_EMERGENCY),
                          nullptr)));
}
