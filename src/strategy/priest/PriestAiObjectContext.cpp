...
class PriestStrategyFactoryInternal : public NamedObjectContext<Strategy>
{
   ...
   private:
    ...
    {
        return new PriestShadowResistanceStrategy(botAI);
    }
    ...
    static Strategy *shadow_debuff(PlayerbotAI *botAI)
    {
        return new ShadowPriestDebuffStrategy(botAI);
    }
...
class PriestTriggerFactoryInternal : public NamedObjectContext<Trigger>
{
   public:
    PriestTriggerFactoryInternal()
    {
        ...
        creators["shadow word: pain on attacker"] =
            &PriestTriggerFactoryInternal::shadow_word_pain_on_attacker;
        creators["dispel magic"] = &PriestTriggerFactoryInternal::dispel_magic;
        creators["dispel magic on party"] =
            &PriestTriggerFactoryInternal::dispel_magic_party_member;
        creators["cure disease"] = &PriestTriggerFactoryInternal::cure_disease;
        creators["party member cure disease"] =
            &PriestTriggerFactoryInternal::party_member_cure_disease;
        creators["power word: fortitude"] = &PriestTriggerFactoryInternal::power_word_fortitude;
        creators["power word: fortitude on party"] =
            &PriestTriggerFactoryInternal::power_word_fortitude_on_party;
        ...
        creators["vampiric touch on attacker"] =
            &PriestTriggerFactoryInternal::vampiric_touch_on_attacker;
        ...
        creators["shadow protection on party"] =
            &PriestTriggerFactoryInternal::shadow_protection_on_party;
        creators["shackle undead"] = &PriestTriggerFactoryInternal::shackle_undead;
        creators["prayer of fortitude on party"] =
            &PriestTriggerFactoryInternal::prayer_of_fortitude_on_party;
        creators["prayer of spirit on party"] =
            &PriestTriggerFactoryInternal::prayer_of_spirit_on_party;
        ...
        creators["silence on enemy healer"] =
            &PriestTriggerFactoryInternal::silence_on_enemy_healer;
        creators["shadowfiend"] = &PriestTriggerFactoryInternal::shadowfiend;
    }

   private:
    static Trigger *vampiric_embrace(PlayerbotAI *botAI)
    {
        return new VampiricEmbraceTrigger(botAI);
    }
    ...
    static Trigger *vampiric_touch_on_attacker(PlayerbotAI *botAI)
    {
        return new VampiricTouchOnAttackerTrigger(botAI);
    }
    static Trigger *devouring_plague(PlayerbotAI *botAI)
    {
        return new DevouringPlagueTrigger(botAI);
    }
    ...
    static Trigger *dispel_magic_party_member(PlayerbotAI *botAI)
    {
        return new DispelMagicPartyMemberTrigger(botAI);
    }
    ...
    static Trigger *power_word_fortitude(PlayerbotAI *botAI)
    {
        return new PowerWordFortitudeTrigger(botAI);
    }
    ...
    static Trigger *divine_spirit_on_party(PlayerbotAI *botAI)
    {
        return new DivineSpiritOnPartyTrigger(botAI);
    }
    ...
    static Trigger *shadow_protection_on_party(PlayerbotAI *botAI)
    {
        return new ShadowProtectionOnPartyTrigger(botAI);
    }
    static Trigger *shadow_protection(PlayerbotAI *botAI)
    {
        return new ShadowProtectionTrigger(botAI);
    }
    static Trigger *shackle_undead(PlayerbotAI *botAI) { return new ShackleUndeadTrigger(botAI); }
    static Trigger *prayer_of_fortitude_on_party(PlayerbotAI *botAI)
    {
        return new PrayerOfFortitudeTrigger(botAI);
    }
    static Trigger *prayer_of_spirit_on_party(PlayerbotAI *botAI)
    {
        return new PrayerOfSpiritTrigger(botAI);
    }
    ...
    static Trigger *touch_of_weakness(PlayerbotAI *botAI)
    {
        return new TouchOfWeaknessTrigger(botAI);
    }
    ...
    static Trigger *silence_on_enemy_healer(PlayerbotAI *botAI)
    {
        return new SilenceEnemyHealerTrigger(botAI);
    }
...
class PriestAiObjectContextInternal : public NamedObjectContext<Action>
{
   public:
    PriestAiObjectContextInternal()
    {
        ...
        creators["shadow word: pain on attacker"] =
            &PriestAiObjectContextInternal::shadow_word_pain_on_attacker;
        ...
        creators["power word: fortitude on party"] =
            &PriestAiObjectContextInternal::power_word_fortitude_on_party;
        ...
        creators["power word: shield on party"] =
            &PriestAiObjectContextInternal::power_word_shield_on_party;
        ...
        creators["abolish disease on party"] =
            &PriestAiObjectContextInternal::abolish_disease_on_party;
        ...
        creators["vampiric touch on attacker"] =
            &PriestAiObjectContextInternal::vampiric_touch_on_attacker;
        ...
        creators["shadow protection on party"] =
            &PriestAiObjectContextInternal::shadow_protection_on_party;
        creators["shackle undead"] = &PriestAiObjectContextInternal::shackle_undead;
        creators["prayer of fortitude on party"] =
            &PriestAiObjectContextInternal::prayer_of_fortitude_on_party;
        creators["prayer of spirit on party"] =
            &PriestAiObjectContextInternal::prayer_of_spirit_on_party;
        creators["power infusion on party"] =
            &PriestAiObjectContextInternal::power_infusion_on_party;
        creators["silence"] = &PriestAiObjectContextInternal::silence;
        creators["silence on enemy healer"] =
            &PriestAiObjectContextInternal::silence_on_enemy_healer;
        ...
        creators["pain suppression on party"] =
            &PriestAiObjectContextInternal::pain_suppression_on_party;
   ...
   private:
    ...
    static Action *shadow_protection(PlayerbotAI *botAI)
    {
        return new CastShadowProtectionAction(botAI);
    }
    ...
    static Action *vampiric_embrace(PlayerbotAI *botAI)
    {
        return new CastVampiricEmbraceAction(botAI);
    }
    ...
    static Action *circle_of_healing(PlayerbotAI *botAI)
    {
        return new CastCircleOfHealingAction(botAI);
    }
    static Action *resurrection(PlayerbotAI *botAI) { return new CastResurrectionAction(botAI); }
    static Action *shadow_word_pain(PlayerbotAI *botAI)
    {
        return new CastPowerWordPainAction(botAI);
    }
    static Action *shadow_word_pain_on_attacker(PlayerbotAI *botAI)
    {
        return new CastPowerWordPainOnAttackerAction(botAI);
    }
    static Action *devouring_plague(PlayerbotAI *botAI)
    {
        return new CastDevouringPlagueAction(botAI);
    }
    ...
    static Action *remove_shadowform(PlayerbotAI *botAI)
    {
        return new CastRemoveShadowformAction(botAI);
    }
    static Action *holy_nova(PlayerbotAI *botAI) { return new CastHolyNovaAction(botAI); }
    static Action *power_word_fortitude(PlayerbotAI *botAI)
    {
        return new CastPowerWordFortitudeAction(botAI);
    }
    ...
    static Action *divine_spirit_on_party(PlayerbotAI *botAI)
    {
        return new CastDivineSpiritOnPartyAction(botAI);
    }
    static Action *power_word_shield(PlayerbotAI *botAI)
    {
        return new CastPowerWordShieldAction(botAI);
    }
    ...
    static Action *greater_heal_on_party(PlayerbotAI *botAI)
    {
        return new CastGreaterHealOnPartyAction(botAI);
    }
    ...
    static Action *lesser_heal_on_party(PlayerbotAI *botAI)
    {
        return new CastLesserHealOnPartyAction(botAI);
    }
    static Action *flash_heal(PlayerbotAI *botAI) { return new CastFlashHealAction(botAI); }
    static Action *flash_heal_on_party(PlayerbotAI *botAI)
    {
        return new CastFlashHealOnPartyAction(botAI);
    }
    static Action *dispel_magic(PlayerbotAI *botAI) { return new CastDispelMagicAction(botAI); }
    static Action *dispel_magic_on_party(PlayerbotAI *botAI)
    {
        return new CastDispelMagicOnPartyAction(botAI);
    }
    static Action *dispel_magic_on_target(PlayerbotAI *botAI)
    {
        return new CastDispelMagicOnTargetAction(botAI);
    }
    ...
    {
        return new CastCureDiseaseOnPartyAction(botAI);
    }
    static Action *abolish_disease(PlayerbotAI *botAI)
    {
        return new CastAbolishDiseaseAction(botAI);
    }
    static Action *abolish_disease_on_party(PlayerbotAI *botAI)
    {
        return new CastAbolishDiseaseOnPartyAction(botAI);
    }
    ...
    static Action *prayer_of_spirit_on_party(PlayerbotAI *botAI)
    {
        return new CastPrayerOfSpiritOnPartyAction(botAI);
    }
    ...
    static Action *fear_ward_on_party(PlayerbotAI *botAI)
    {
        return new CastFearWardOnPartyAction(botAI);
    }
    static Action *fear_ward(PlayerbotAI *botAI) { return new CastFearWardAction(botAI); }
    static Action *desperate_prayer(PlayerbotAI *botAI)
    {
        return new CastDesperatePrayerAction(botAI);
    }
    static Action *shadowguard(PlayerbotAI *botAI) { return new CastShadowguardAction(botAI); }
    static Action *hex_of_weakness(PlayerbotAI *botAI)
    {
        return new CastHexOfWeaknessAction(botAI);
    }
    static Action *touch_of_weakness(PlayerbotAI *botAI)
    {
        return new CastTouchOfWeaknessAction(botAI);
    }
    ...
    static Action *prayer_of_healing(PlayerbotAI *botAI)
    {
        return new CastPrayerOfHealingAction(botAI);
    }
    ...
    static Action *silence_on_enemy_healer(PlayerbotAI *botAI)
    {
        return new CastSilenceOnEnemyHealerAction(botAI);
    }
    static Action *silence(PlayerbotAI *botAI) { return new CastSilenceAction(botAI); }
    static Action *power_infusion_on_party(PlayerbotAI *botAI)
    {
        return new CastPowerInfusionOnPartyAction(botAI);
    }
    static Action *binding_heal(PlayerbotAI *botAI) { return new CastBindingHealAction(botAI); }
    static Action *prayer_of_mending(PlayerbotAI *botAI)
    {
        return new CastPrayerOfMendingAction(botAI);
    }
    static Action *pain_suppression_on_party(PlayerbotAI *botAI)
    {
        return new CastPainSuppressionProtectAction(botAI);
    }
    static Action *pain_suppression(PlayerbotAI *botAI)
    {
        return new CastPainSuppressionAction(botAI);
    }
    ...
    static Action *shadow_word_death(PlayerbotAI *botAI)
    {
        return new CastShadowWordDeathAction(botAI);
    }
