...
ShadowPriestStrategy::ShadowPriestStrategy(PlayerbotAI *botAI) : GenericPriestStrategy(botAI) { actionNodeFactories.Add(new ShadowPriestStrategyActionNodeFactory()); }
...
NextAction **ShadowPriestStrategy::getDefaultActions()
{
    return NextAction::array(0, new NextAction("mind blast", ACTION_DEFAULT + 0.2f),
                             ...
                             new NextAction("mind flay", ACTION_DEFAULT + 0.1f), new NextAction("shoot", ACTION_DEFAULT), NULL);
}
