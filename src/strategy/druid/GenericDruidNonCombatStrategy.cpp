...
void GenericDruidNonCombatStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(
        new TriggerNode("gift of the wild", NextAction::array(0, new NextAction("gift of the wild", 15.0f), nullptr)));
...
void GenericDruidBuffStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(
        new TriggerNode("gift of the wild", 
                        NextAction::array(0, new NextAction("gift of the wild", 14.0f), nullptr)));
