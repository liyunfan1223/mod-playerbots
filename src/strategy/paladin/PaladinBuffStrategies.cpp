...
void PaladinFireResistanceStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(0, new NextAction("fire resistance aura", ACTION_NORMAL), nullptr)));
}
...
void PaladinBuffAoeStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    triggers.push_back(new TriggerNode(
        "retribution aura",
        NextAction::array(0, new NextAction("retribution aura", ACTION_NORMAL), nullptr)));
}
...
void PaladinBuffCastStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    triggers.push_back(new TriggerNode(
        "concentration aura",
        NextAction::array(0, new NextAction("concentration aura", ACTION_NORMAL), nullptr)));
}
