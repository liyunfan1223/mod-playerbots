...
GenericPaladinNonCombatStrategy::GenericPaladinNonCombatStrategy(PlayerbotAI *botAI)
...
void GenericPaladinNonCombatStrategy::InitTriggers(std::vector<TriggerNode *> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "party member dead",
        NextAction::array(0, new NextAction("redemption", ACTION_CRITICAL_HEAL + 10), nullptr)));
    triggers.push_back(new TriggerNode(
