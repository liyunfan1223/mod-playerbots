...
bool PlayerbotAIConfig::Initialize()
{
    ...
    randomBotLogoutOutsideLoginRange =
        sConfigMgr->GetOption<bool>("AiPlayerbot.RandomBotLogoutOutsideLoginRange", false);
    ...
    LoadSet<std::set<uint32>>(
        sConfigMgr->GetOption<std::string>("AiPlayerbot.AoeAvoidSpellWhitelist", "50759,57491,13810"),
    ...
    LoadList<std::vector<uint32>>(sConfigMgr->GetOption<std::string>(
                                      ...
                                      "7848,3802,5505,6502,7761,10277,10285,11492,13188,13189,24499,24511,24710,24712"),
                                  randomBotQuestIds);
    ...
    permanantlyInWorldTime = sConfigMgr->GetOption<int32>("AiPlayerbot.PermanantlyInWorldTime", 1 * YEAR);
