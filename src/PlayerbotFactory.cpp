...
float PlayerbotFactory::CalculateItemScore(uint32 item_id, Player* bot)
{
    ...
    {
        // AGILITY only
        score += agility * 2.5 + attack_power + armor_penetration * 2 + rangeDps * 5 + hit * 1.2 + crit * 2 +
                 haste * 2 + intellect;
    }
    ...
    {
        // SPELL DPS
        score += intellect * 0.5 + spirit * 0.5 + spell_power + spell_penetration + hit * 0.7 + crit * 0.7 + haste * 1 +
                 rangeDps;
    }
    ...
    else if (cls == CLASS_ROGUE || (cls == CLASS_DRUID && tab == 2 && !PlayerbotAI::IsTank(bot)))
    {
        ...
        score += agility * 2 + strength + attack_power + armor_penetration * 1 + meleeDps * 5 + hit * 1 + crit * 1.5 +
                 haste * 1.5 + expertise * 1.5;
    }
    ...
    )
    {
        ...
        score += strength * 2 + agility + attack_power + armor_penetration + meleeDps * 5 + hit * 1 + crit * 1.5 +
                 haste * 1.5 + expertise * 1.5;
    }
    ...
    {  // enhancement
        ...
        score += strength * 1 + agility * 1.5 + intellect * 1.5 + attack_power + spell_power * 1.5 +
                 armor_penetration * 0.5 + meleeDps * 5 + hit * 1 + crit * 1.5 + haste * 1.5 + expertise * 1.2;
    }
    ...
    else if (cls == CLASS_DEATH_KNIGHT && tab == 0)
    {
        ...
        score += strength * 1 + agility * 2 + attack_power * 0.2 + defense * 3.5 + parry * 2 + dodge * 2 +
                 resilience * 2 + armor * 0.3 + stamina * 2.5 + hit * 0.5 + crit * 0.5 + haste * 0.5 + expertise * 2;
    }
    else
    {
        // BEAR DRUID TANK
...
float PlayerbotFactory::CalculateEnchantScore(uint32 enchant_id, Player* bot)
{
    ...
    {
        // AGILITY only
        score += agility * 2.5 + attack_power + armor_penetration * 2 + dps * 5 + hit * 1.5 + crit * 2 + haste * 2.5 +
                 intellect;
    }
    else if (cls == CLASS_WARLOCK || cls == CLASS_MAGE || (cls == CLASS_PRIEST && tab == 2) ||  // shadow
             (cls == CLASS_SHAMAN && tab == 0) ||                                               // element
    ...
    {
        // AGILITY mainly (STRENGTH also)
        score += agility * 2 + strength + attack_power + armor_penetration * 1 + dps * 5 + hit * 1.2 + crit * 1.5 +
    ...
    {
        // STRENGTH mainly (AGILITY also)
        score += strength * 2 + agility + attack_power + armor_penetration + dps * 5 + hit * 1.2 + crit * 1.5 +
    ...
    {  // enhancement
        // STRENGTH mainly (AGILITY, INTELLECT also)
        score += strength * 1 + agility * 1.5 + intellect * 1.5 + attack_power + spell_power * 1.5 +
                 armor_penetration * 0.5 + dps * 5 + hit * 1.2 + crit * 1.5 + haste * 1.5 + expertise * 2;
    }
    else if ((cls == CLASS_WARRIOR && tab == 2) || (cls == CLASS_PALADIN && tab == 1))
    {
        // TANK WITH SHIELD
...
float PlayerbotFactory::CalculateSpellScore(uint32 spell_id, Player* bot, uint32 trigger)
{
    ...
    {
        // AGILITY only
        score += agility * 2.5 + attack_power + armor_penetration * 2 + rangeDps * 5 + hit * 1.5 + crit * 2 +
                 haste * 2.5 + intellect;
    }
    else if (cls == CLASS_WARLOCK || cls == CLASS_MAGE || (cls == CLASS_PRIEST && tab == 2) ||  // shadow
             (cls == CLASS_SHAMAN && tab == 0) ||                                               // element
    ...
    {
        // AGILITY mainly (STRENGTH also)
        score += agility * 2 + strength + attack_power + armor_penetration * 1 + meleeDps * 5 + hit * 1.2 + crit * 1.5 +
                 haste * 1.5 + expertise * 2.5;
    }
    else if ((cls == CLASS_PALADIN && tab == 2) ||    // retribution
             (cls == CLASS_WARRIOR && tab != 2) ||    // arm / fury
    ...
    {
        // STRENGTH mainly (AGILITY also)
        score += strength * 2 + agility + attack_power + armor_penetration + meleeDps * 5 + hit * 1.2 + crit * 1.5 +
                 haste * 1.5 + expertise * 2;
    }
    else if ((cls == CLASS_SHAMAN && tab == 1))
    {  // enhancement
        // STRENGTH mainly (AGILITY, INTELLECT also)
        score += strength * 1 + agility * 1.5 + intellect * 1.5 + attack_power + spell_power * 1.5 +
                 armor_penetration * 0.5 + meleeDps * 5 + hit * 1.2 + crit * 1.5 + haste * 1.5 + expertise * 2;
    }
    else if ((cls == CLASS_WARRIOR && tab == 2) || (cls == CLASS_PALADIN && tab == 1))
    {
        // TANK WITH SHIELD
