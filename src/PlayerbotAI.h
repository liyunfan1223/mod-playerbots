...
enum SharpeningStoneDisplayId
{
    ...
    CONSECRATED_SHARPENING_DISPLAYID = 24674,  // will not be used because bot can not know if it
                                               // will face undead targets
...
public:
    ...
    // Checks if the bot is really a player. Players always have themselves as
    // master.
